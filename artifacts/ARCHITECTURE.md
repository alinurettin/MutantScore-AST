# 📐 System Architecture: MutantScore-AST
...
```mermaid
flowchart TD
    CLI["💻 CLI Interface (src/cli.js)"] --> Engine["🧠 MutantScore-AST Algorithmic Engine (src/mutation_engine.js)"]
...
1. **Algorithmic Engine (`src/mutation_engine.js`):** Core logic implementing Mutation Testing & Test Suite Quality Assessment. Zero third-party runtime bloat.
2. **REST API & Web Server (`src/index.js`):** Lightweight HTTP microservice running on port 7071 providing health probes and interactive endpoints.
